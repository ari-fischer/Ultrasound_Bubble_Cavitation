...
z=readmatrix("rho_l_z_value");
r=readmatrix("rho_l_Rsq.csv");
omega_M=readmatrix("rho_l_omega_M.csv");
PA_M=readmatrix("rho_l_PA_M.csv");
H2O_cons=readmatrix("rho_l_H2O_cons.csv");
H2Os=readmatrix("rho_l_H2O_init.csv");
...
f = gcf;
exportgraphics(f,'contour_rho.png','Resolution',300)
