...
z=readmatrix("PA_z_value.csv");
r=readmatrix("PA_Rsq.csv");
omega_M=readmatrix("PA_omega_M.csv");
PA_M=readmatrix("PA_PA_M.csv");
H2O_cons=readmatrix("PA_H2O_cons.csv");
H2Os=readmatrix("PA_H2O_init.csv");
...
f = gcf;
exportgraphics(f,'contour_PA.png','Resolution',300)
