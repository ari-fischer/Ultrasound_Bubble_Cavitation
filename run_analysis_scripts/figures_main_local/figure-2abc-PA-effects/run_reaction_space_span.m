...
for i=1:length(PA_space)
    ...
    for j=1:length(omega_space)
        ...
        %% extract rxn energy
        [u_rxn_int,delu_max,delu_min] = get_rxn_energy(T_profile,Mw_vector,kin_param,T0,thermo_dat_params,...
...
save('figure-2-plot--355kHz-3_2--1_10bar')
